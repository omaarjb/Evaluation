...
public class TestEtatCivil {
    ...
    public static void main(String[] args) {
        // Load the Spring context using your active config
        AnnotationConfigApplicationContext ctx =
                new AnnotationConfigApplicationContext(HibernateUtil.class);

        // Retrieve service beans
        ...
        try {
            ...
            for (Object[] r : dets) {
                ...
                if (dateFin == null) {
                    System.out.printf(
                            "%d. Femme : %-13s Date Début : %-12s Nbr Enfants : %d%n",
            ...
            for (Object[] r : dets) {
                ...
                if (dateFin != null) {
                    System.out.printf(
                            "%d. Femme : %-13s Date Début : %-12s %n   Date Fin : %-12s Nbr Enfants : %d%n",
